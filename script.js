    ...
    .then((response) => {
      ...
      fetch(`https://forecast9.p.rapidapi.com/rapidapi/forecast/${lattitude}/${longitude}/summary/`,options_forecast)
        ...
        .then((response) =>{
          ...
          const temperatureData = [temp1,temp2,temp3,temp3,temp4,temp5];
          const temperatureDataMin = [min_temp1,min_temp2,min_temp3,min_temp4,min_temp5];
          ...
          let chart_lable = [date1,date2,date3,date4,date5];
...
const temperatureChart = new Chart(chart_max, {
  ...
  data: {
    ...
    datasets: [{
      label: 'Temperature (°C)',
      data: [0, 0, 0, 0, 0], // Initial data will be replaced
      fill: true,
    ...
    },
    {
      ...
      data: [0, 0, 0, 0, 0], // Initial data for Min Temp
      fill: true,
